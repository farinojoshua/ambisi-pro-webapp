    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('admin.properties.update', $property->property_id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('name', $property->name) }}" name="name"
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2">
                            ...
                            <input value="{{ old('bedrooms', $property->bedrooms) }}" name="bedrooms"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2">
                            ...
                            <input value="{{ old('bathrooms', $property->bathrooms) }}" name="bathrooms"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2">
                            ...
                            <input value="{{ old('land_area', $property->land_area) }}" name="land_area"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2">
                            ...
                            <input value="{{ old('building_area', $property->building_area) }}" name="building_area"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('electricity', $property->electricity) }}" name="electricity"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('water', $property->water) }}" name="water"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <select name="garage" id="garage" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" required>
                                <option value="1" {{ old('garage', $property->garage) == '1' ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('garage', $property->garage) == '0' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('certificate', $property->certificate) }}" name="certificate"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <textarea name="material_building" id="material_building"
                                      class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                      placeholder="Material Building">{{ old('material_building', $property->material_building) }}</textarea>
                        </div>
                        <div class="w-full px-3 mb-6">
                            ...
                            <textarea name="material_floor" id="material_floor"
                                      class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                      placeholder="Material Floor">{{ old('material_floor', $property->material_floor) }}</textarea>
                        </div>
                        <div class="w-full px-3 mb-6">
                            <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="dining_room">
                                Dining Room
                            </label>
                            <input value="{{ old('dining_room', $property->dining_room) }}" name="dining_room"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('living_room', $property->living_room) }}" name="living_room"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('video_url', $property->video_url) }}" name="video_url"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                   id="video_url" type="url" placeholder="Video URL">
                        </div>
                        <div class="w-full px-3 mb-6">
                            <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="price">
                                Price
                            </label>
                            <input value="{{ old('price', $property->price) }}" name="price"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                   id="price" type="number" step="0.01" placeholder="Price" required>
                        </div>
                        <div class="w-full px-3 mb-6">
                            <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="year_built">
                                Year Built
                            </label>
                            <input value="{{ old('year_built', $property->year_built) }}" name="year_built"
                                   class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                   id="year_built" type="text" placeholder="Year Built">
                        </div>
                        <div class="w-full px-3 mb-6">
