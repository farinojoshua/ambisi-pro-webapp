<x-app-layout>
    <x-slot name="title">Add Developer</x-slot>
    <x-slot name="header">
      <h2 class="text-xl font-semibold leading-tight text-gray-800">
        <a href="#!" onclick="window.history.go(-1); return false;">
          ←
        </a>
        {!! __('Developer &raquo; Add') !!}
      </h2>
    </x-slot>
    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          @endif
          <form class="w-full" action="{{ route('admin.developers.store') }}" method="post" enctype="multipart/form-data">
            @csrf
